...
// [PATCH-myia #29] getCliSocketPath retained — the welcome-DM probe connects
// to the CLI socket, a Windows named pipe on this install.
import { CENTRAL_DB_PATH, DATA_DIR, getCliSocketPath, GROUPS_DIR } from '../src/config.js';
