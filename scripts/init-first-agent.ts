...
// [PATCH-myia #29] getCliSocketPath retained — used at the CLI socket bind
// site (Windows named pipe); upstream dropped it but the bind still needs it.
import { DATA_DIR, getCliSocketPath, GROUPS_DIR } from '../src/config.js';
