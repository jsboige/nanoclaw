...
import { formatMessages, stripInternalTags, stripLegacyTaskContract, stripLeakedMcpToolcalls } from './formatter.js';
...
// [PATCH-myia #16] z.ai SDK occasionally leaks `<mcp__server__tool>...</...>`
// envelopes as plain text. These tests guard the strip helper that scrubs
// them before fallback delivery.
