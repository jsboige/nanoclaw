...
import { getPendingMessages, markCompleted, markProcessing, resetProcessingAcks } from './messages-in.js';
...
describe('resetProcessingAcks (PATCH-myia #18)', () => {
  test('removes processing claim — message becomes pending again', () => {
    insertMessage('m1', 2, 'chat', { text: 'hi' });
    markProcessing(['m1']);
  ...
  test('only resets the specified ids', () => {
    insertMessage('m1', 2, 'chat', { text: 'hi' });
    insertMessage('m2', 4, 'chat', { text: 'hi' });
