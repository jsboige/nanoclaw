...
// getContainerSpawnedAt returns null — the documented "tests don't track spawn
// time" sentinel — so decideStuckAction's startup-grace branch is skipped and
// the claim-stuck path is reached on the later tick (upstream v2.1.17 added
// this export + the spawnedAt startup grace; the justWoke gate under test is
// independent of it).
